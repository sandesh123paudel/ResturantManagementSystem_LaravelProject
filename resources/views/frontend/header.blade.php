                ...
                <div class="ml-auto">
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a class="nav-link" href="/" style="color: black;">Home <span
                            ...
                            @auth
                                ...
                                @else
                                    @if (Auth::user()->email_verified_at)
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="{{ url('my-profile') }}" style="color: black;">My
                                                Profile</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="{{ url('my-orders') }}" style="color: black;">My
                                                Orders</a>
                                            <div class="dropdown-divider"></div>
                                    ...
                                    @else
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="{{ url('verify-email') }}"
                                                style="color: black;">Verify Email</a>
