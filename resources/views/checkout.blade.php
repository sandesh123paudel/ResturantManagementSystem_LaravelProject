                    ...
                    <div class="card-body">
                        ...
                        <div class="row checkout-form" style="text-align: left">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" min="1" class="form-control" value="{{Auth::user()->phone}}" name="phone" placeholder="Enter Phone Number">
                                @error('phone')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            </div>
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button class="btn btn-secondary order-placed" {{ $totalPrice == 0 ? 'disabled' : '' }}>Place Order</button>
